      ...
      <section className="bg-blue-50 py-16">
        <div className="container-custom text-center">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            منصة سكن صنعاء هي الحل الأمثل للباحثين عن شقق للإيجار في صنعاء بدون وسطاء أو عمولات إضافية
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                تأسست منصة سكن صنعاء استجابةً للتحديات التي يواجهها الباحثون عن سكن في صنعاء، حيث يضطر الكثيرون للتعامل مع وسطاء العقارات ودفع عمولات مرتفعة.
              </p>
              <p className="text-gray-600 mb-4">
                نهدف إلى توفير منصة بسيطة وفعالة تربط مباشرة بين المستأجرين وأصحاب العقارات، مما يلغي الحاجة للوسطاء ويجعل عملية البحث عن سكن أكثر شفافية وأقل تكلفة.
              </p>
              <p className="text-gray-600">
                نحن فريق محلي من صنعاء نسعى لتحسين تجربة البحث عن سكن في مدينتنا وجعلها تجربة سهلة وخالية من المتاعب.
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">نتحقق من جميع الإعلانات لضمان دقة المعلومات وحماية المستخدمين.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">نتيح التواصل المباشر بين المستأجرين والملاك دون أي وسطاء.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">فريقنا المحلي جاهز لمساعدتك في أي استفسارات أو مشكلات.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600">خبير في مجال العقارات مع أكثر من 10 سنوات من الخبرة في سوق العقارات اليمني.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-primary mb-3">مديرة العمليات</p>
              <p className="text-gray-600">متخصصة في تطوير الأعمال وتحسين تجربة المستخدم في المنصات الرقمية.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <p className="text-primary mb-3">رئيس قسم التكنولوجيا</p>
      ...
      <section className="py-16">
        <div className="container-custom text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            هل لديك استفسارات أو ملاحظات؟ فريقنا جاهز للمساعدة
          </p>
